...
let itemsInCart = document.getElementsByName('.cart-item-counter').innerHTML = itemsInCarrito;

console.log('itemsInCart ' + typeof(itemsInCart) + ' ' + itemsInCart)


//Array de productos para ser recorrido
let arrayProdsDeconstr = JSON.parse(localStorage.arrayCarrito);

console.log(arrayProdsDeconstr);
